...
app.post('/channels/:channelName/chaincodes/:chaincodeName/GetRecord', async function(req, res) {
	...
	var fcn = "Get";
	let peer = 'peer0.orgc.atlchain.com';
...
app.post('/channels/:channelName/chaincodes/:chaincodeName/putTx', async function(req, res) {
	...
	var peers = ['peer0.orgc.atlchain.com'] ;
    var fcn = "Put";
    ...
    switch(storageType) {
        ...
        case "hbase" :
            ...
            break;
        case "hdfs" :
            await fs.writeFileSync('../web/tmp/' + hash, data);

            hdfsClient.put("../web/tmp/" + hash, hdfsDir + hash, function(){
...
app.post('/channels/:channelName/chaincodes/:chaincodeName/AddRecord', async function(req, res) {
    ...
    switch(storageType) {
        ...
        case "hbase" :
            ...
            break;
        case "hdfs" :
            await fs.writeFileSync('../web/tmp/' + hash, imgdata, 'binary');
