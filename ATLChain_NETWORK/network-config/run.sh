...
then
    ...
    echo "### peer channel create -o 148.70.109.243:7050 -c atlchannel -f atlchannel.tx ###"
    peer channel create -o 148.70.109.243:7050 -c atlchannel -f atlchannel.tx

    echo "### peer channel join -b atlchannel.block ###"
    peer channel join -b atlchannel.block
    
    echo "###  peer channel update -o 148.70.109.243:7050 -c atlchannel -f OrgAanchors.tx ###"
    peer channel update -o 148.70.109.243:7050 -c atlchannel -f OrgAanchors.tx
    ...
    echo "### peer chaincode instantiate -o 148.70.109.243:7050 -C atlchannel -n cc -v 1.0 -c '{"Args":["init","a","100","b","200"]}' ###"
    peer chaincode instantiate -o 148.70.109.243:7050 -C atlchannel -n cc -v 1.0 -c '{"Args":["init","a","100","b","200"]}'
...
then
    echo "### invoke ###"
    peer chaincode invoke -o 148.70.109.243:7050 -C atlchannel -n cc -c '{"Args":["invoke","a","b","1"]}'
fi
